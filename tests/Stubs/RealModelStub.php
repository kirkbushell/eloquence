...
class RealModelStub extends Model implements CountCache
{
     ...
     * needs to update a Role's user count cache.
     *
     *   return [ 'users_count' => [ 'Role', 'role_id', 'id' ] ];
     *
     * So, to extend, the first argument should be an index representing the counter cache on the
     * associated model. Next is a numerical array:
     *
     ...
     *
     * Ie. another way to setup a counter cache is like so:
     *
     *   return [ 'users_count' => 'Role' ];
     *
