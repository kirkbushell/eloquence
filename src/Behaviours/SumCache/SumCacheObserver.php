...
class SumCacheObserver
{
    ...
    /**
     * Whenever a new model is created, we want to increment the related model's sum cache.
     *
     * @param Model $model
     */
    ...
    /**
     * Whenever a model is deleted, we decrement the related model object's sum cache.
     *
     * @param Model $model
     */
